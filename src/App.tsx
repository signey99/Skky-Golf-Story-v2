...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans" id="app-root-wrapper">
      {/* Premium Header */}
      <header className="bg-white border-b border-slate-100 fixed top-0 left-0 right-0 z-40 shadow-xs h-[72px] md:h-[96px] flex items-center" id="app-main-header">
        <div className="max-w-4xl w-full mx-auto px-3 py-2.5 md:px-4 md:py-4 flex items-center justify-between" id="header-inner">
          <div className="flex items-center gap-3" id="header-brand">
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className="text-base md:text-lg text-pink-300 font-bold tracking-wide mt-1.5 font-brush leading-none text-shadow-sm" id="header-subtitle">
                시근이와 계영이의 골프이야기
              </p>
            </div>
          </div>
      ...
      <main className="flex-1 max-w-4xl w-full mx-auto px-1.5 pt-0 pb-3 md:px-4 md:pt-0 md:pb-8 pb-16 md:pb-28" id="app-main-content">
