...
export const CourseTab: React.FC<CourseTabProps> = ({
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-5" id="course-tab-container">
      ...
      <div className="sticky top-[72px] md:top-[96px] z-30 bg-slate-50/90 backdrop-blur-md -mx-1.5 px-1.5 md:-mx-4 md:px-4 py-1.5 border-b border-slate-200/80 flex flex-col gap-1.5" id="course-tab-header">
        <div className="flex items-center justify-between" id="course-title-row">
        ...
        <div className="relative flex items-center" id="course-search-wrapper">
