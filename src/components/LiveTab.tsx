...
export const LiveTab: React.FC<LiveTabProps> = ({
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6" id="live-scorecard-container">
      {/* Unified Tab Header */}
      <div className="sticky top-[72px] md:top-[96px] z-30 bg-slate-50/90 backdrop-blur-md -mx-1.5 px-1.5 md:-mx-4 md:px-4 py-1.5 flex items-center justify-between border-b border-slate-200/80" id="live-tab-header">
            ...
            <table className="w-full text-center border-separate border-spacing-0 rounded-none overflow-hidden text-[10px] xs:text-[11px] sm:text-xs font-mono table-fixed" id="out-table">
              ...
              <thead>
                <tr className="bg-emerald-50" id="out-table-header">
                  {/* Hole Header Title */}
                  <th className="py-1 px-0 sm:py-3 sm:px-3 text-center font-sans font-extrabold text-green-700 bg-emerald-50 border-t-2 border-b-2 border-l-2 border-r-2 border-slate-400 truncate">
                    Hole
                  </th>
                      ...
                      <th 
                        ...
                        className={`py-1 px-0 sm:py-3 sm:px-1 font-black cursor-pointer transition-all ${
                          isActive 
                            ...
                            : `text-green-700 bg-emerald-50 border-t-2 border-b-2 ${idx === 8 ? '' : 'border-r'} border-slate-400`
                        }`}
                      >
                        {idx + 1}
                      </th>
                  ...
                  <th className="py-1 px-0 sm:py-3 sm:px-2 font-black text-green-700 bg-emerald-50 border-t-2 border-b-2 border-l-2 border-l-slate-400 border-r-2 border-slate-400 truncate">
                    OUT
                  </th>
              ...
              <tbody>
                ...
                <tr id="out-par-row" className="bg-white">
                  <td className="py-1 px-0.5 sm:py-3 sm:px-3 text-center font-sans font-extrabold text-[#334155] border-b-2 border-l-2 border-r-2 border-slate-400 bg-white">
                    Par
                  </td>
                  {outPars.map((par, idx) => {
                    const isActive = idx === (activeGame.currentHole !== undefined ? activeGame.currentHole : 0);
                      ...
                      <td 
                        ...
                        className={`py-1 px-0.5 sm:py-3 sm:px-1 font-black transition-all cursor-pointer bg-white ${
                          isActive 
                            ...
                            : `text-[#fca5a5] border-b-2 ${idx === 8 ? '' : 'border-r'} border-slate-400`
                        }`}
                      >
                        {par}
                      </td>
                  ...
                  <td className="py-1 px-0.5 sm:py-3 sm:px-2 font-black text-green-600 bg-white border-b-2 border-l-2 border-l-slate-400 border-r-2 border-slate-400">
                    {outParSum}
                  </td>
                ...
                <tr id="out-p1-row" className={p1RowBg}>
                  <td className={`py-1 px-0.5 sm:py-2.5 sm:px-3 text-center font-sans font-black text-[#475569] text-[10px] xs:text-xs sm:text-sm md:text-base border-b border-l-2 border-r-2 border-slate-400 uppercase truncate ${p1NameBg}`}>
                      ...
                      <td 
                        ...
                        className={`p-0.5 transition-all ${p1RowBg} ${
                          isActive 
                            ...
                            : isClickable
                              ? `border-b ${idx === 8 ? '' : 'border-r'} border-slate-400 cursor-pointer hover:bg-slate-100/40`
                              : `border-b ${idx === 8 ? '' : 'border-r'} border-slate-400`
                        }`}
                      >
                  ...
                  <td className={`py-1 px-0.5 sm:py-2.5 sm:px-2 border-b border-l-2 border-l-slate-400 border-r-2 border-slate-400 text-center ${p1OutInBg}`}>
                    {(() => {
                ...
                <tr id="out-p2-row" className={p2RowBg}>
                  <td className={`py-1 px-0.5 sm:py-2.5 sm:px-3 text-center font-sans font-black text-[#475569] text-[10px] xs:text-xs sm:text-sm md:text-base border-b-2 border-l-2 border-r-2 border-slate-400 uppercase truncate ${p2NameBg}`}>
                      ...
                      <td 
                        ...
                        className={`p-0.5 transition-all ${p2RowBg} ${
                          isActive 
                            ...
                            : isClickable
                              ? `border-b-2 ${idx === 8 ? '' : 'border-r'} border-slate-400 cursor-pointer hover:bg-slate-100/40`
                              : `border-b-2 ${idx === 8 ? '' : 'border-r'} border-slate-400`
                        }`}
                      >
                        <div className="w-full h-6 sm:h-9 flex items-center justify-center">
                           {renderHoleScoreBadge(score, par)}
                  ...
                  <td className={`py-1 px-0.5 sm:py-2.5 sm:px-2 border-b-2 border-l-2 border-l-slate-400 border-r-2 border-slate-400 text-center ${p2OutInBg}`}>
                    {(() => {
        ...
        {editingScoreState.isOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 bg-slate-900/60 backdrop-blur-xs overflow-y-auto">
            ...
            >
              ...
              {/* Modal Header */}
              <div className="flex items-center justify-center gap-3 mb-3 sm:mb-5 shrink-0">
                <span className="bg-[#ecfdf5] text-[#005a36] px-3.5 py-1.5 rounded-full text-lg sm:text-xl font-black uppercase">
                  ⛳ Hole {editingScoreState.holeIdx + 1}
                </span>
                <span className="text-rose-500 text-lg sm:text-xl font-black uppercase">
                  PAR {editingScoreState.par}
                </span>
              </div>
